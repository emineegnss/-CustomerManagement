...
public class SRHExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(SRHDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new SRHStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static SRHDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static SRHDateTimeConverter dateTimeConverter = new SRHStandardDateTimeConverter();

    public SRHExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public SRHExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new SRHMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=SRHHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,SRHExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=SRHHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
