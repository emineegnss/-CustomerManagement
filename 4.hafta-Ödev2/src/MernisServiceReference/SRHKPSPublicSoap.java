...
public class SRHKPSPublicSoap
{
    ...
    public SRHKPSPublicSoap(){}

    public SRHKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public SRHKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        SRHExtendedSoapSerializationEnvelope envelope= new SRHExtendedSoapSerializationEnvelope(SRHExtendedSoapSerializationEnvelope.VER11);
